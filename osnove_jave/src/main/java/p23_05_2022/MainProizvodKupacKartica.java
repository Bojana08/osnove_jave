...
public class MainProizvodKupacKartica {
...
//●	konstuktore
        ...
        Kartica k = new Kartica(10, "9329-0239");
        Kupac n = new Kupac("Jovan Jovanovic", k);
        Proizvod knjiga = new Proizvod("Knjiga", n, 1515);

        knjiga.cenaProizvoda();
        knjiga.stampaj();
